...
export const ProfileScreen = () => {
  ...
  const { activeSocietyId, allSocieties, mySocietyIds, profile, selectedInterests, activeSocietyRole } = useLocalAppState();
  const { currentMode, canSwitchToAdmin } = useUserRoles();
